...
class GRU_fusion(nn.Module):
    def __init__(self, opt, n_node, num_classes, num_layers=3, dropout=0.0):
        super(GRU_fusion, self).__init__()
        self.num_layers = num_layers
        self.hidden_size = opt.hidden_size
        self.embedding = nn.Embedding(num_classes, self.hidden_size)
        self.gru = nn.GRU(input_size=self.hidden_size, hidden_size=self.hidden_size, num_layers=num_layers, dropout=dropout, batch_first=True)
        ...
        self.dim_matcher = nn.Linear(self.hidden_size, num_classes)
