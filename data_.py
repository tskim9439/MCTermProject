...
if __name__ == "__main__":
    ...
    print("Total number of sessions: ", len(data))
    
    train_data, valid_data = train_test_split(data, test_size=0.2, random_state=100)
    ...
    """
    import pickle
    with open("train_data_10.pkl", "wb") as f:
        pickle.dump(train_data, f)
    with open("valid_data_10.pkl", "wb") as f:
    ...
    with open("node_info.pkl", "wb") as f:
